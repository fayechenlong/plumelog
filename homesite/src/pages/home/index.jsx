...
class Home extends Language {
  ...
  render() {
    ...
    const headerLogo = headerType === 'primary' ? '/pic/icon_name.png' : '/pic/icon_name_black.png';
    return (
      <div className="home-page">
        ...
        <section className="start-section">
          <div className="start-body">
            ...
            <div className="right-part"><img src={getLink('/pic/nr1.png')} /></div>
          </div>
        </section>
        ...
        <Footer logo="/pic/icon_name_black.png" language={language} />
      </div>
    );
  }
}
